<?php /* Smarty version 2.6.26, created on 2013-08-25 03:08:10
         compiled from /home/avazquez/public_html/opendocman//templates/common/login.tpl */ ?>
        <html>
        <head>
...
">
        ...
        <td><input type="password" name="frmpass" size="15"><br />
...
/signup.php"><?php echo $this->_tpl_vars['g_lang_signup']; ?>
        ...
        <p>
        <?php echo $this->_tpl_vars['g_lang_welcome3']; ?>
