...
$lang['welcome'] = 'Bienvenido al control de documentaci&oacute;n';
...
$lang['welcome3'] = 'Puede entrar como usuario. No puede acceder a la administración, en esta versión demo. USUARIO: user. PASSWD: 97hrm59';
...
$lang['message_this_site_has_high_security'] = 'Este sitio tiene niveles de seguridad que nos impiden recuperar su contrase&ntilde;a, usted puede usar el formulario para reeestablecerla .  Ingrese su nombre de usuario y se le enviar&aacute; a su correo un mensaje con un v&iacute;nculo que le permitir&aacute; restablecerla. Luego de ello podr&aacute; cambiarla a la que usted desee.';
