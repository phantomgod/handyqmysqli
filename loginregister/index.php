	...
	<div class="row">
	    ...
	    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
			<form role="form" method="post" action="" autocomplete="off">
				...
				<div class="form-group">
					<input type="text" name="actividad" id="actividad" class="form-control input-lg" placeholder="cliente o tecnico (minúscula sin acentos)" value="<?php if(isset($error)){ echo $_POST['actividad']; } ?>" tabindex="4">
				</div>
