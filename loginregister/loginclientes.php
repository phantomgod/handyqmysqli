...
if( $user->is_logged_in() ){ header('Location: indexclientes.php'); } 
...
//define page title
$title = 'Login usuarios BIOCONTROL';
...
<div class="container">
	<div class="row">
		...
		<div class="col-lg-6">
			<h2><small>Login / Registro para la consulta de datos de usuario</small></h2>
		</div>
	</div>
	<div class="row">
	    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
			<form role="form" method="post" action="" autocomplete="off">
				...
				<p><a href='indexclientes.php'><i class="glyphicon glyphicon-arrow-left"></i> <b>Ir a la página de registro</b></a></p>
				<hr>
				...
				<div class="row">
					<div class="col-xs-9 col-sm-9 col-md-9">
						 <a href='resetclientes.php'>Olvidó su password?</a>
					</div>
				</div>
