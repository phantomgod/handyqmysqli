...
if ($aktion == "print") { 
   ...
   <section id="c1">
        ...
        <div class="page-header">
            <h1>Gráficas de EC de laboratorio</h1>
        </div>
...
if ($aktion == "print_id") { 
   @$id = $_GET['id']; 
$result = mysqli_query($mysqli,  "SELECT username, fechainicioensayo, oec
									FROM  `analiticas` 
...
if ($result) {
		...
		?>
		  <div class="alert alert-info alert-fixed-top">
				 <a href="javascript:history.go(-1)" title="<?php echo GENERAL_VOLVER ?>"><i class="fa fa-step-backward fa-2x" style="color:Grey;"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<small>Gráfica de EC (&#181;S) del <span class='text-success'>Laboratorio</span> de la granja: <span class='text-success'>&nbsp;<?php echo $id ?>&nbsp;</span></small> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../../assets/img/logo.png" width="250px">
		  </div>
		<?php
...
<br /><br />
 ...
 <div class="container">
    ...
    <script>
        ...
        chart.Set('chart.title', 'EC (µS) de laboratorio');
