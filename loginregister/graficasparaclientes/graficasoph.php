...
if ($aktion == "print") { 
   ...
   <section id="c1">
        ...
        <div class="page-header">
            <h1>Gráficas  de pH de Laboratorio</h1>
        </div>
		<table class="table table-bordered table-hover">
			...
			//echo"<td><img src='../../assets/img/$row[0].png'>".$row[1]."</td>";
					...
					echo '<td><a href="analiticas_print.php?&amp;aktion=print_id&amp;id=' . $row['id'] . '" alt="Image Tooltip" rel="tooltip" content="<table class=print2>
								...
								<tr style=background-color:rgba(192,192,192,0.3);>
								<th style=color:MidnightBlue; colspan=6><div class=text-center>Laboratorio</div></th>
								</tr>
								<tr>
								<th>Biocida</th>
								<th>Redox</th>
			...
			echo"<td>".$row[11]."</td>";
			 ...
			 echo "<td><a href='graficaspph.php?&amp;aktion=print_id&amp;id=".$row['1']."'><span class='icon icon-signal' aria-hidden='true'></span></a></td>";
			echo"</tr>";
			}
			?>
...
if ($aktion == "print_id") { 
   @$id = $_GET['id']; 
$result = mysqli_query($mysqli,  "SELECT username, fechainicioensayo, oph
									FROM  `analiticas` 
...
if ($result) {
		...
		?>
		  <div class="alert alert-info alert-fixed-top">
				 <a href="javascript:history.go(-1)" title="<?php echo GENERAL_VOLVER ?>"><i class="fa fa-step-backward fa-2x" style="color:Grey;"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<small>Gráfica de pH del <span class='text-success'>Laboratorio</span> de la granja: <span class='text-success'>&nbsp;<?php echo $id ?>&nbsp;</span></small> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../../assets/img/logo.png" width="250px">
		  </div>
		<?php
...
<br /><br />
 ...
 <div class="container">
    ...
    <script>
        ...
        chart.Set('chart.title', 'pH de Laboratorio');
        ...
        chart.Set('chart.colors', ['DarkGreen']);
