...
if ($aktion == "print") { 
   ...
   <section id="c1">
        ...
        <div class="page-header">
            <h1>Gráficas de TDS de almacén</h1>
        </div>
...
if ($result) {
		?>
		  <div class="alert alert-info alert-fixed-top">
				 <a href="javascript:history.go(-1)" title="<?php echo GENERAL_VOLVER ?>"><i class="fa fa-step-backward fa-2x" style="color:Grey;"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<small>Gráfica de TDS (ppm) del <span class='text-success'>Almacén</span> de la granja: <span class='text-success'>&nbsp;<?php echo $id ?>&nbsp;</span></small> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../../assets/img/logo.png" width="250px">
		  </div>
		<?php
	$labels = array ();
	$labels2 = array ();
...
<br /><br />
 ...
 <div class="container">
    ...
    <script>
        ...
        chart.Set('chart.title', 'TDS (ppm) Almacén');
