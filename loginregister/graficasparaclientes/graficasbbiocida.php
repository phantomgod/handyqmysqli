...
if ($aktion == "print") { 
   ...
   <section id="c1">
        ...
        <div class="page-header">
            <h1>Gráficas de BIOCIDAS de bebederos</h1>
        </div>
		<table class="table table-bordered table-hover">
			...
			echo"<td>".$row[11]."</td>";
			 ...
			 echo "<td><a href='graficasbbiocida.php?&amp;aktion=print_id&amp;id=".$row['1']."'><span class='icon icon-signal' aria-hidden='true'></span></a></td>";
			echo"</tr>";
			}
			?>
...
if ($aktion == "print_id") { 
   @$id = $_GET['id']; 
$result = mysqli_query($mysqli,  "SELECT username, fechainicioensayo, bbiocida
									FROM  `analiticas` 
...
<br /><br />
 ...
 <?php
		...
		echo "<div class='alert alert-success'>Gráfica de BIOCIDA del <span class='text-success'>bebedero</span> de la granja: <span class='text-success'>&nbsp;$id&nbsp;</span></div>";
		echo "</div>";
		?>
    <canvas id="cvs" width="1100" height="300">[No canvas support]</canvas>
    <script>
        chart = new RGraph.Line('cvs', <?php print($data_string) ?>);
        chart.Set('chart.title', 'Biocida bebedero (ppm)');
