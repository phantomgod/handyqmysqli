...
$database_visitors = "biovazqu_avazquez"; 
$username_visitors = "biovazqu_avazque"; 
$password_visitors = "mip@@@#5940"; 

$visitors = ($GLOBALS["___mysqli_ston"] = mysqli_connect($hostname_visitors,  $username_visitors,  $password_visitors)) or trigger_error(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)),E_USER_ERROR);
