...
$_pagi_sql = "SELECT s.Id id1, s.codigoobjetivo, s.accion, s.responsable, s.fechalimite, s.fechaterminacion, s.observaciones, g.*
...
require "includes/paginator.inc.php";
              ...
              echo OBJETIVOS_JOIN;      
                ...
                echo '<p align="left">';
                echo '<a class="tooltip2" href="#"><b><i class="fa fa-comment-o fa-2x" style="color:#00bcd4;"></i></b><span class="custom info"><img src="images/Info.png" alt="Info" title="Info" height="48" width="48" /><em>
      ...
      echo '</caption>';
       <?php*/ 
        ...
        echo '<th style width="5%"><a href="#" title="'.OBJETIVOS_MODIFICAR_TAREA.'">';
            echo '<i class="fa fa-edit fa-2x" style="color:Gold;"></i></a></th>';
...
?>
						<div class="ToolText"  onMouseOver="javascript:this.className='ToolTextHover'" onMouseOut="javascript:this.className='ToolText'">
							...
							<span>
								...
								<a href="?seccion=objetivos_admin&aktion=add" title="< ?php echo ANADIR; echo "&nbsp;"; echo NC; echo "&nbsp;"; echo $row ['0']; ?>"><i class="fa fa-plus fa-2x" style="position:absolute; left:10px; top:10px; color:#9fff30;"></i></a><!--</div>-->
								
								<a href="?seccion=objetivos_admin&aktion=change_id&id=<?php echo $row ['0']; ?>" title="<?php echo EDITAR; echo "&nbsp;"; echo NC; echo "&nbsp;"; echo $row ['0']; ?>"><i class="fa fa-pencil fa-2x" style="position:absolute; left:50px; top:10px; color:#9fff30;"></i></a>
								...
								<a href="?seccion=objetivos_print&amp;aktion=print_id&id=<?php echo $row ['0']; ?>" title="<?php echo IMPRIMIR; echo "&nbsp;"; echo NC; echo "&nbsp;"; echo $row ['0']; ?>"><i class="fa fa-print fa-2x" style="position:absolute; left:210px; top:10px; color:#9fff30;"></i></a>
