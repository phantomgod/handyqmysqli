...
$query = "SELECT * FROM areassensibles";
...
if ($result) {
	...
	echo "<form method='post' action='?seccion=borradas_areassensibles' OnSubmit='return onDelete(); '>";
	echo "<table class='sortable'>";
	echo "<caption>";
	echo PROVEEDORES_BORRAR_AREASSENSIBLES;
	echo "</caption>";
	echo "<tbody>";
	echo "<tr>";
	echo "<th>ID</th>";
