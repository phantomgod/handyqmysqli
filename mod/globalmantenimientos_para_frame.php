...
<?php
    ...
    * Change these to your own credentials*/
    ...
    $result = mysqli_query($mysqli, "SELECT submitdate, 28338X23X126 FROM lime_survey_28338");
    if ($result) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            $labels[] = $row["submitdate"];
			$labels2[] = $row["28338X23X126"];
            $data[]   = $row["28338X23X126"];
        }
...
<body>
    ...
    <script>
        ...
        chart.Set('chart.title', 'Valoración global Mantenimientos');
