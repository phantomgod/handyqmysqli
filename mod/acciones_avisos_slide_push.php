...
#flotante {
	...
	<!-- *********************************************************** -->
		<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s4">
			<h3>Auditorías</h3>
				<div onMouseOver="showdiv(event,'<?php echo MENU_ALT_ADMINISTRAR_AUDITORIAS; ?>');" onMouseOut="hiddenDiv()" style='display:table;margin-top3px;'>
					<a href="?seccion=aisgc_admin&amp;aktion=add"><i class="fa fa-plus fa-2x" style="position:relative; left:10px; top:0px; color:#F44336;"></i></a>
				</div>

				<div onMouseOver="showdiv(event,'<?php echo MENU_ALT_ADMINISTRAR_AUDITORIAS; ?>');" onMouseOut="hiddenDiv()" style='display:table;margin-top3px;'>
					<a href="?seccion=aisgc_admin&amp;aktion=change"><i class="fa fa-edit fa-2x" style="position:relative; left:10px; top:0px; color:#F44336;"></i></a>
				</div>

				<div onMouseOver="showdiv(event,'<?php echo MENU_ALT_BORRAR_AUDITORIAS; ?>');" onMouseOut="hiddenDiv()" style='display:table;margin-top3px;'>
					<a href="?seccion=checkbox3_aisgc"><i class="fa fa-trash-o fa-2x" style="position:relative; left:10px; top:0px; color:#F44336;"></i></a>
				</div>
				<div onMouseOver="showdiv(event,'<?php echo MENU_ALT_IMPRIMIR_AUDITORIAS; ?>');" onMouseOut="hiddenDiv()" style='display:table;margin-top3px;'>
					<a href="?seccion=aisgc_print&amp;aktion=print"><i class="fa fa-print fa-2x" style="position:relative; left:10px; top:0px; color:#F44336;"></i></a>
				</div>
				<div onMouseOver="showdiv(event,'<?php echo MENU_ALT_BUSCAR_AUDITORIAS; ?>');" onMouseOut="hiddenDiv()" style='display:table;margin-top3px;'>
					<a href="?seccion=searchaisgc"><i class="fa fa-search fa-2x" style="position:relative; left:10px; top:0px; color:#F44336;"></i></a>
				</div>
				<div onMouseOver="showdiv(event,'<?php echo MENU_ALT_LISTA_AUDITORIAS; ?>');" onMouseOut="hiddenDiv()" style='display:table;margin-top3px;'>
					<a href="?seccion=listaisgc"><i class="fa fa-list-ul fa-2x" style="position:relative; left:10px; top:0px; color:#F44336;"></i></a>
				</div>
				<div onMouseOver="showdiv(event,'<?php echo MEDICIONES; ?>');" onMouseOut="hiddenDiv()" style='display:table;margin-top3px;'>
					<a href="?seccion=tabsframesmediciones"><i class="fa fa-line-chart fa-2x" style="position:relative; left:10px; top:0px; color:white;"></i></a>
				</div>
		...
		<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s6">
			<h3>No conformidades</h3>
				...
				<div onMouseOver="showdiv(event,'<?php echo NCS_IMPRIMIR_NCS; ?>');" onMouseOut="hiddenDiv()" style='display:table;margin-top3px;'>
					<a href="?seccion=paginatormysqliainc"><i class="fa fa-retweet fa-2x" style="position:relative; left:10px; top:0px; color:#ff0000;"></i></a></div>
	...
	<!-- *********************************************************** -->
		<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s8">
			<h3>Indicadores</h3>
				...
				<div onMouseOver="showdiv(event,'<?php echo INDICADORES_VALORACIONGLOBALMANTENIMIENTOS; ?>');" onMouseOut="hiddenDiv()" style='display:table;margin-top3px;'><a href="?seccion=globalmantenimientos"><i class="fa fa-bar-chart" style="position:relative; left:10px; top:0px; color:Turquoise;"></i></a></div>
						...
						<tr>
							<td>									
								<div onMouseOver="showdiv(event,'<?php echo CALIBRACIONES_ANADIR; ?>');" onMouseOut="hiddenDiv()" style='display:table;margin-top3px;'>
									<a href="?seccion=calibraciones_admin&amp;aktion=add"><i class="fa fa-retweet fa-2x" style="color:LightCoral;"></i></a>
								</div>
							</td>
							<td>									
			...
			<div id="avion">
				<section>
					...
					<div onmouseover="showdiv(event,'Avisos');" onmouseout="hiddenDiv()" style="display:table;margin-right:10px;float:left;">
						<a href="#" id="showLeft">
							<i class="fa fa-list-ul fa-2x fa-2x" style="color:#2db300;"></i>
						</a>
					</div> 
					...
					<div onmouseover="showdiv(event,'Objetivos.');" onmouseout="hiddenDiv()" style="display:table;margin-right:10px;float:left;">
						<a href="#" id="showLeft7">
							<i class="fa fa-long-arrow-up fa-2x fa-rotate-90" style="color:#ffff00;"></i>
						</a>
					</div>
					...
					<div onmouseover="showdiv(event,'Revisión del sistema.');" onmouseout="hiddenDiv()" style="display:table;margin-right:10px;float:left;">
						<a href="#" id="showLeft9">
							<i class="fa fa-flash fa-2x" style="color:#646473;"></i>
						</a>
					</div>
