...
function onDelete() {
    if ( confirm('<?php echo EQUIPOS_QUIERE_BORRAR; ?>\n <?php echo RECUERDE_SELECCIONAR; ?>')==true) {
        return true;
    } else {
        return false;
    }
...
$query = "SELECT * FROM equiposdemedida";
...
if ($result) {
      ...
      // create a new form and then put the results into a table.
        ...
        echo "<form method='post' action='?seccion=borrados_equipos' OnSubmit='return onDelete(); '>";
