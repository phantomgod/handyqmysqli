...
?>
<br />
<form name="frmMain" action="?seccion=checkbox2_codigosincidenciasinspecciones"
	method="post" OnSubmit="return onDelete();">
	<?php

        $strSQL = "SELECT * FROM codigosincidenciasinspecciones";
        $objQuery = mysqli_query($mysqli, $strSQL) or die ("Error Query [".$strSQL."]");
?>


	<?php echo DELETE_ADVERTICE; ?>
	<span class="yellow"><?php echo CODIGO_INCIDENCIA; ?></span>
	...
	<table id="myTable" class="sortable">
		...
		<tbody>
			...
			while ($objResult = mysqli_fetch_array($objQuery)) {
				...
				?>
			<tr>
				<td><?php echo $objResult["codincid"];?></td>
				<td><?php echo $objResult["nombreincid"];?></td>
				<td>
