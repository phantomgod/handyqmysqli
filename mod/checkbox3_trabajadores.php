...
$result = mysqli_query($mysqli, 'select count(*) AS count from ( SELECT * FROM trabajadores ) m');
...
<form name="frmMain" action="?seccion=checkbox2_trabajadores"
...
?>
	...
	<?php echo '&emsp;&emsp;<span class="yellow">' . TRABAJADOR_BORRAR_TRABAJADOR . '</span>'; ?>
	<table id="myTable" class="sortable">
		<thead>
			<tr>
				<!--<th>ID</th>-->
				<th><?php echo TRABAJADOR; ?></th>
				<th><?php echo TRABAJADOR_ACTIVIDAD; ?></th>
				<th><?php echo IMAGEN_URL; ?></th>
		...
		while ($objResult = mysqli_fetch_array($objQuery)) {
			...
			<!--<td>< ?php echo $objResult['id'];?></td>-->
				...
				<td><?php echo $objResult['actividad'];?></td>
				<td><img src="<?php echo $objResult['imgsrc'];?>" width="50px" alt="<?php echo $objResult['trabajador'];?>" title="<?php echo $objResult['trabajador'];?>"></td>
				<td><a href='?seccion=trabajadores_admin2c&amp;aktion=change_id&amp;id=<?php echo $objResult['id'];?>' /><i class="fa fa-pencil" style="color:yellow;"></i></a></td>
