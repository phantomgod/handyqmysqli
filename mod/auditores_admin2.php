...
if ($aktion == "add") {
    if ((empty($_POST['auditor'])) AND (empty($_POST['activo']))) {
            ...
            echo '<tbody>';
              echo '<tr>';
                ...
                echo '</th>';
				   ...
				   echo '<td><input type="text" class="input-xxlarge" id="auditor" name="auditor" value=""></td>';
              echo '</tr>';
              echo '<tr>';
                echo '<th>';
               ?>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/help.png" /></div>-->
						...
						<div align="left">
							<p class="pleft">
								<?php echo SELECCIONAR_IMAGEN; ?>
								<a class="tooltip2" href="#"><i class='fa fa-question fa-2x' style='color:Darkslateblue;'></i>
									<span class="custom info">
										<img src="images/Help2.png" alt="Help" title="Help" height="48" width="48" />
											<em><?php echo ATENCION; ?></em><?php echo IMAGEN_HELP; ?>
									</span>
								</a>								
							</p>
        ...
        if (isset($_POST['activo'])) {
            ...
            $sql =    mysqli_query($mysqli, "INSERT INTO auditores (id, auditor, imgsrc, activo) VALUES ('".$id_Post."', '".$auditor_Post."', '".$imgsrc_Post."', '".$activo_Post."')");
        if ($sql) {
        ...
        <meta http-equiv="refresh" content="3; URL=?seccion=auditores_print&amp;aktion=print">
...
if ($aktion == "change_id") {
    if ((empty($_POST['auditor_change'])) AND (empty($_POST['imgsrc_change'])) AND (empty($_POST['activo_change']))) {
            ...
            if ($file != "." && $file != "..") {
             ...
             echo '<tr>';
               ...
               echo '</th>';
                ...
                echo '<td>1: '.ACTIVO.', 0: '.INACTIVO.'</td>';
             echo '</tr>';
        ...
        $id = (int)$_GET['id'];
        $sql = mysqli_query($mysqli, "UPDATE auditores SET auditor='$_POST[auditor_change]', imgsrc='$_POST[imgsrc_change]', activo='$_POST[activo_change]' WHERE id = $id");
        echo "<span class='documenttitle'>";
