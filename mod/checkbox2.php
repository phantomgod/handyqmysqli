<?php
/**
* Mod RECIBE Y BORRA los avisos (tabla avisos)
...
<html>
<head>
<meta http-equiv="refresh" content="2; URL=?seccion=checkbox3">
...
$objQuery = mysqli_query($mysqli, $strSQL);
	...
	echo '<div id="alert">';
    echo '<a class="alert" href="#alert">' . AVISO_BORRADO . '</a>&nbsp;';
    echo '</div>';
