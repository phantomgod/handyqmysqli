...
?>
		...
		<?php echo TRABAJADOR_ADMINISTRAR_TRABAJADORES; ?>/ 
			<a href="?seccion=trabajadores_admin2&amp;aktion=add"><?php echo TRABAJADOR_ANADIR_TRABAJADOR; ?></a></td>::
			<a href="?seccion=trabajadores_admin2c&amp;aktion=change"><?php echo TRABAJADOR_CAMBIAR_TRABAJADOR; ?></a></td>
...
if ($aktion == "change_id") {
                ...
                echo '</caption>';
                    echo '<tr>';
                        echo '<th>';
                            echo TRABAJADOR;
                        echo '</th>';
							echo '<td><input type="text" class="form-control input-xxlarge" id="trabajador_change" name="trabajador_change" value="'.$data[1].'"></td>';
                    echo '</tr>';
                    echo '<tr>';
                        echo '<th>';
                            echo TRABAJADOR_ACTIVIDAD;
                        echo '</th>';
							echo '<td><input type="text" class="form-control input-xxlarge" id="actividad_change" name="actividad_change" value="'.$data[2].'"></td>';
                    echo '</tr>';
                    echo '<tr>';
                        echo '<th>';
	...
	<!--<a href='javascript:void(0);' onclick='$("#images").imageSelector("next")'>next</a>&nbsp;&nbsp;&nbsp;
			...
			<?php
                              ...
                              echo '</td>';
                              echo '<td><img src='.$data[3].' width="150px">&nbsp;&nbsp;'.IMAGENACTUAL.'</td>';
                    ...
                    echo '<tr>';
                        ...
                        echo '</th>';
                           echo '<td>';
                            ...
                            echo '</td>';
                    echo '</tr>';
                           echo '<td colspan="2"><input type="submit" class="btn btn-success" value="'.ACTUALIZAR.'">';
                                echo " &nbsp;&nbsp;<button class='btn btn-info' onclick='history.go(-1);'>";
                                     echo VOLVER;
                                echo "</button>";
                           echo '</td>';
                    echo '</tr>';
...
<meta http-equiv="refresh"
	content="3; URL=?seccion=trabajadores_admin2c&amp;aktion=change">
<?php
        }
    }
}
