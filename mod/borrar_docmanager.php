...
if ($result) {
    ...
    echo "<form method='post' action='?seccion=borrados_docmanager' OnSubmit='return onDelete();'>";
     echo "<table class='sortable'>";
        echo "<tr>";
         echo "<th>";
          echo NOMBRE_DOCUMENTO;
         echo "</th><th>";
          echo DOCUMENTO_AUTOR;
         echo "</th><th>";
          echo FECHA;
         echo "</th>";
         echo "</tr>";
