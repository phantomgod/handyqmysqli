...
?>
    ...
    <canvas id="cvs2" width="1100px" height="300px">[No canvas support]</canvas>
     <script>
        ...
        line1.Set('chart.colors', ['mediumorchid']);
...
?>
    ...
    <script>
        ...
        line2.Set('chart.colors', ['lime#9fff30']);
...
<?php
    ...
    <script>
        ...
        line3.Set('chart.colors', ['SandyBrown']);
...
?>
    ...
    <canvas id="cvs6" width="1100" height="250">[No canvas support]</canvas>
     <script>
        ...
        line4.Set('chart.colors', ['DimGray']);
