...
if (isset($_GET['q'])) {
    ...
    // palabra clave
    $aCampos = array ('ai', 'numhoja', 'descripcion', 'fecha', 'afectaa', 'docum', 'abiertopor', 'causas', 'acciones', 'cerradofecha');
    // Realizamos la búsqueda indicando la
    // tabla la base de datos donde
    // buscaremos
    buscar('hojasdemejora', $aCampos, 10);
    ...
    mostrar('numhoja', 'descripcion', 'id', '../?seccion=ncs_print&amp;aktion=print_id&amp;id=', 10);
