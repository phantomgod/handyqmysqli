...
* de proveedores (áreas afectadas)
...
<html>
<head>
<meta http-equiv="refresh" content="3; URL=?seccion=checkbox3_codigosincidencias">
...
for ($i=0;$i<count($_POST["chkDel"]);$i++) {
    if ($_POST["chkDel"][$i] != "") {
		...
		echo '<div id="alert">';
			echo '<a class="alert" href="#alert">' . PROVEEDORES_CODIGOINCIDENCIA_BORRADO . '</a>&nbsp;';
		echo '</div>';
		echo "<br /><br />";	
