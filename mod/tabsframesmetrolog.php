...
<body>
	...
	<div id="panel">
		<ul id="tabs">
			<li id="tab_01"><a href="#" onclick="tab('tab_01','panel_01');" title="<?php echo AUDITORIAS; ?>">
			<i class="fa fa-eye fa-2x" style="color:#FF5722;"></i><?php echo AUDITORIAS; ?></a></li>
			<li id="tab_02"><a href="#" onclick="tab('tab_02','panel_02');" title="<?php echo MENU_AINFORMES; ?>">
			<i class="fa fa-pencil fa-2x" style="color:#1A237E;"></i><?php echo MENU_AINFORMES; ?></a></li>
				...
				<table class="table">
					<tr>
						<td>
								...
								onMouseOver="javascript:this.className='ToolTextHover'"
								onMouseOut="javascript:this.className='ToolText'">
								<a href="?seccion=auditorias_admin" title="<?php echo MENU_ALT_ADMINISTRAR_AINFORMES; ?>">
								<button><i class="fa fa-edit fa-2x" style="color:#1A237E;"></i></button>
								<span><?php echo MENU_ALT_ADMINISTRAR_AINFORMES; ?></span></a></p></td>
						<td>
								<p class="ToolText"
								onMouseOver="javascript:this.className='ToolTextHover'"
								onMouseOut="javascript:this.className='ToolText'">
						...
						<td>
								...
								onMouseOver="javascript:this.className='ToolTextHover'"
								onMouseOut="javascript:this.className='ToolText'">
								<a href="?seccion=ai_nc"><button><i class="fa fa-retweet fa-2x" style="color:#1A237E;"
				...
				<table class="table">
					<tr>
						...
						<td>
								...
								onMouseOver="javascript:this.className='ToolTextHover'"
								onMouseOut="javascript:this.className='ToolText'">
								<a href="?seccion=inspecciones_por_servicio&amp;aktion=print"><button><i class="fa fa-retweet fa-2x" style="color:black;"
				...
				<table class="table">
					<tr>
						...
						<td>
								...
								onMouseOver="javascript:this.className='ToolTextHover'"
								onMouseOut="javascript:this.className='ToolText'">
								<a href="?seccion=ai_nc"><button><i class="fa fa-retweet fa-2x" style="color:#9fff30;"
						alt="<?php echo NCS_IMPRIMIR_NCS; ?>" title="<?php echo NCS_IMPRIMIR_NCS; ?>"></i></button><span><?php echo NCS_IMPRIMIR_NCS; ?></span></a></p></td>
						<td>
								<p class="ToolText"
								onMouseOver="javascript:this.className='ToolTextHover'"
				...
				<table class="table">
					<tr>
						...
						<td>
								...
								onMouseOver="javascript:this.className='ToolTextHover'"
								onMouseOut="javascript:this.className='ToolText'">
								<a href="?seccion=seguimientos_por_objetivo&amp;aktion=print"><button><i class="fa fa-retweet fa-2x" style="color:#752209;"
