	...
	if(isset($_POST['btnsave']))
	{
		...
		if(!isset($errMSG))
		{
			...
			if($stmt->execute())
			{
				...
				//header("refresh:5;?seccion=members"); // redirects image view page after 5 seconds.
				echo '<meta http-equiv="refresh" content="5; url=?seccion=members">';
			}
			else
			{
...
<div class="container">
	...
	<div class="page-header">
    	<h1 class="h2">add new user. <a class="btn btn-default" href="?seccion=members"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; view all </a></h1>
    </div>
