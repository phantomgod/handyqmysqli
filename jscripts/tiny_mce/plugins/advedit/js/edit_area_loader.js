...
******/
    ...
    function EditAreaLoader(){
      ...
      ,load_callback: ""        // click on load button (function name)
        ...
        this.advanced_buttons = [
                ...
                ['new_document', 'newdocument.png', 'new_document'],
                ['search', 'search.png', 'show_search'],
                ['go_to_line', 'go_to_line.png', 'go_to_line'],
                ['undo', 'undo.png', 'undo'],
                ['redo', 'redo.png', 'redo'],
                ['change_smooth_selection', 'smooth_selection.png', 'change_smooth_selection_mode'],
                ['reset_highlight', 'reset_highlight.png', 'resync_highlight'],
                ['highlight', 'highlight.png','change_highlight'],
                ['help', 'help.png', 'show_help'],
                ['save', 'save.png', 'save'],
                ['load', 'load.png', 'load'],
                ['fullscreen', 'fullscreen.png', 'toggle_full_screen']
            ];
    ...
    */    
    ...
    EditAreaLoader.prototype.get_button_html= function(id, img, exec) {
  ...
  //    if(!baseURL)
    ...
    html+= '<img id="' + id + '" src="img/' + img + '" title="{$' + id + '}" width="20" height="20" class="editAreaButtonNormal" onmouseover="editArea.switchClass(this,\'editAreaButtonOver\');" onmouseout="editArea.restoreClass(this);" onmousedown="editArea.restoreAndSwitchClass(this,\'editAreaButtonDown\');" /></a>';
    ...
    EditAreaLoader.prototype.get_control_html= function(button_name, lang) {        
        ...
        switch (button_name){
            ...
            case "|":
              case "separator":
                return '<img src="img/spacer.png" width="1" height="15" class="editAreaSeparatorLine">';
            case "select_font":
