editAreaLoader.load_syntax["php2"] = {
    'COMMENT_SINGLE' : {1 : '//', 2 : '#'}
    ,'COMMENT_MULTI' : {'/*' : '*/'}
    ,'QUOTEMARKS' : {1: "'", 2: '"'}
    ...
    ,'KEYWORDS' : {
        'statements' : [
                       ...
                       'endif', 'switch', 'case', 'endswitch', 'return', 'break', 'continue','echo','exit'
            
                      ],
    'construct' :  [ '_GET', '_POST', '_SERVER', '_FILES', '_ENV', '_COOKIE', '_REQUEST',
    ...
    //
        ,'functions' : [
            ...
            'print', 'global', 'static', 'array', 'empty', 'eval', 'isset', 'unset',
    ...
    ,'STYLES' : {
           ...
           'QUOTESMARKS': 'color: #60CA00;',
        'KEYWORDS' : {
               'reserved' : 'color: #000;font-weight:bold;',
              'functions' : 'color: #0040FD;',
           'statements' : 'color: #879EFA;font-weight:bold;',
            'construct' : 'color: #000;font-weight:bold;'
            },
