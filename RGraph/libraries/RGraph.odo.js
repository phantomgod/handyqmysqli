    ...
    RGraph.Odometer = function (conf)
    {
        ...
        */
        ...
        this.properties =
        {
            ...
            'chart.green.color':            'Gradient(black:#0c0)',
            'chart.yellow.color':           'Gradient(black:#ff0)',
            'chart.red.color':              'Gradient(black:#f00)',
            'chart.label.area':             35,
        ...
        */
        ...
        this.DrawBackground = function ()
        {
            ...
            */
            ...
            // Now draw a big black circle to make the lines appear as tick marks
        ...
        */
        ...
        this.DrawNeedle = function (value, color)
        {
            ...
            /**
            * Draw a black circle at the centre
            */
            co.beginPath();
            co.fillStyle = 'gray';
            co.moveTo(this.centerx, this.centery);
