    ...
    RGraph.Line = function (conf)
    {
        ...
        */
        ...
        this.properties =
        {
            ...
            'chart.labels.above.background': 'black',
            ...
            'chart.hmargin':                0,
            'chart.tickmarks.dot.stroke':   'black',
            ...
            if (   tickmarks == 'circle'
                ...
                if (tickmarks == 'circle'|| tickmarks == 'filledcircle' || (tickmarks == 'endcircle' && (index == 0 || index == (lineData.length - 1)))) {
                    ...
                    if (tickmarks == 'filledcircle') {
                        ...
                        co.fillStyle = isShadow ? prop['chart.shadow.color'] : 'black';
                    }
        ...
        */
        ...
        this.DrawAboveLabels = function ()
        {
            var size       = prop['chart.labels.above.size'],
                ...
                bgcolor    = prop['chart.labels.above.background'] || 'black',
                border     = ((
        ...
        this.Highlight = function (shape)
        {
            if (prop['chart.tooltips.highlight']) {
                ...
                if (typeof prop['chart.highlight.style'] === 'function') {
                    ...
                    // Clear a space in black first for the tickmark
                    ...
                    RG.path2(obj.context, 'b a % % 7 0 6.2830 false f black',
                        shape.x,
                        shape.y
                    );
