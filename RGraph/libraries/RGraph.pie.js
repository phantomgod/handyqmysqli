    ...
    RGraph.Pie = function (conf)
    {
        ...
        */
        ...
        this.properties =
        {
            ...
            'chart.colors':                 ['red', '#ccc', '#cfc', 'blue', 'pink', 'yellow', 'black', 'orange', 'cyan', 'purple', '#78CAEA', '#E284E9', 'black', 'blue', '#9E7BF6'],
            ...
            'chart.labels.ingraph.bounding.fill':'black',
        ...
        this.Draw = function ()
        {
            ...
            */
            if (prop['chart.labels.sticks']) {
                ...
                // Redraw the border going around the Pie chart if the stroke style is NOT black
        ...
        this.Highlight = function (shape)
        {
            if (prop['chart.tooltips.highlight']) {
                ...
                */
                    ...
                    // Draw a black-out where the segment is
                    co.beginPath();
                        RG.NoShadow(this);
