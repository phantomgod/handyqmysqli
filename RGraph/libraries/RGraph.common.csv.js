// version: 2016-10-09
    ...
    */
    ...
    RGraph.CSV = function (url, func)
    {
        ...
        *                    {
        *                        preserve: false, // Whether to preserve blackspace
        ...
        */
        this.fetch = function ()
        {
            ...
            if (this.url.substring(0,3) == 'id:') {
                ...
                // Get rid of any surrounding blackspace
                ...
                RGraph.AJAX.getString(this.url, function (data)
                {
                    ...
                    */
                    for (var i=0,len=obj.data.length; i<len; i+=1) {
                        /**
                        * Use the new split function to split each row NOT preserving blackspace
                        */
                        //var row = obj.data[i].split(sep);
                        var row = obj.splitCSV(obj.data[i], {preserve: false, char: sep});
