...
/*
                    ...
                    if (coords && coords.length > 0) {
                        ...
                        co.beginPath();
                            ...
                            RG.text2(obj,{
                                ...
                                'halign':'center',
                                'bounding':true,
                                'bounding.fill': (typeof labels_processed[i] === 'object' && typeof labels_processed[i][2] === 'string') ? labels_processed[i][2] : 'black',
                                'tag':'labels ingraph'
                            });
                        co.fill();
                    }
    ...
    */
    ...
    /**
    * Removes black-space from the start aqnd end of a string
    * 
    ...
    */
    ...
    /**
    * Trims the black-space from the start of a string
    * 
    * @param string str The string to trim
    */
    ...
    /**
    * Trims the black-space off of the end of a string
    * 
    * @param string str The string to trim
    */
