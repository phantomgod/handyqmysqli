...
(function (win, doc, undefined)
{
    ...
    */
    RG.Effects.Common.fadeCircularInOutwards = function ()
    {
        ...
        // Create the cover
        $('<div id="rgraph_fadeslide_cover_' + obj.id + '"></div>').css({
            background: 'radial-gradient(rgba(255,255,255,0) 0%, black ' + radius + '%)',
            width:obj.canvas.width + 'px',
            height: obj.canvas.height + 'px',
            top: canvasXY[1],
            left: canvasXY[0],
    ...
    */
    RG.Effects.Common.fadeCircularOutOutwards = function ()
    {
        ...
        // Create the cover
        $('<div id="rgraph_fadeslide_cover_' + obj.id + '"></div>').css({
            background: 'radial-gradient(rgba(255,255,255,0) 0%, black 0%)',
            width:obj.canvas.width + 'px',
            height: obj.canvas.height + 'px',
            top: canvasXY[1],
            left: canvasXY[0],
    ...
    RG.Effects.Common.reveal = function ()
    {
        ...
        for (var i=0,len=divs.length; i<len; ++i) {
            var div = document.createElement('DIV');
                ...
                div.style.backgroundColor = opt && typeof opt.color === 'string' ? opt.color : 'black';
        ...
        */
        function iterator ()
        {
            ...
            obj.context.save();
                ...
                // Clear the canvas to a black color
                if (opt.background) {
    ...
    */
    RG.Effects.Common.conceal = function ()
    {
        ...
        var callback = arguments[1] || function () {};
        var xy       = RG.getCanvasXY(obj.canvas);
        var color    = opt.background || opt.color || opt.backgroundColor || 'black';
