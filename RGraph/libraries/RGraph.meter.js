        ...
        */
        ...
        this.DrawBackground = function ()
        {
            ...
            */
            ...
            // Second, draw the darker tickmarks. First run draws them in black to get rid of the existing tickmark,
            // then the second run draws them in the requested color
            
            
            if (prop['chart.tickmarks.big.num']) {
                var colors = ['black','black',prop['chart.tickmarks.big.color']];
            ...
            // Draw the black circle that makes the tickmarks
            co.beginPath();
            co.fillStyle = prop['chart.background.color'];
            co.moveTo(this.centerx, this.centery);
...
//
            ...
            for (var i=0; i<=numLabels; ++i) {
                ...
                RG.text2(this, {
                    ...
                    'bounding':false,
                    'boundingFill':(i == 0 || i == numLabels) ? 'black': null,
                    'tag': 'scale'
                });
            }
        };
