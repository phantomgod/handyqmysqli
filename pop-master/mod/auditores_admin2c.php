...
<caption><?php echo AUDITORES_ADMINISTRAR_AUDITORES; ?></caption> 
 <tbody> 
   <tr> 
    <td width="20%"><a href="?seccion=auditores_admin2&amp;aktion=add"><?php echo AUDITORIAS_ANADIR_AUDITOR; ?></a></td>
    <td><a href="?seccion=auditores_admin2c&amp;aktion=change"><?php echo AUDITORIAS_CAMBIAR_AUDITOR; ?></a></td>    
  </tr> 
 </tbody> 
</table> 
<br> 
            ...
            echo '<tbody>'; 
             ...
             <? php */
              ...
              /*echo '<tr>'; 
                echo '<th>'; 
             /*?> 
                         <div id="help" onMouseOver="showdiv(event,'<?php echo GENERAL_IMAGEN_HELP ?>');" onMouseOut="hiddenDiv()" style='display:table;margin-top3px;'> 
               <?php 
        ...
        while (false!==($file = readdir($handle))) {
            if ($file != "." && $file != "..") {
                ...
                echo "<option value=\"mod/ajaximage/uploads/$file\">$file</option>\n";
                  ...
                  echo '</td><td><img src='.$data[2].' border="0">&nbsp;&nbsp;'.GENERAL_IMAGENACTUAL.'</td>';
               ...
               echo '</th>'; 
                   echo '<td>';  
                                    ...
                                    echo '<select size="1" name="activo_change">'; 
                                       ...
                                       echo '<option  value="1">'.GENERAL_ACTIVAR.'</option>'; 
                                       echo '<option  value="0">'.GENERAL_DESACTIVAR.'</option>'; 
                                    echo '</select>';
                                    
                                    echo '&nbsp;1: &nbsp;'.GENERAL_ACTIVO.', &nbsp; 0: &nbsp; '.GENERAL_INACTIVO.'';
