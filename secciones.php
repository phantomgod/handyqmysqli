...
$_GET["seccion"] = (isset($_GET["seccion"])) ? $_GET["seccion"] : '';
switch ($_GET["seccion"]){
//...........................................................PORTADA
//Modulo x defecto
default:
...
case 'listavisos';
        ...
        $acciones = 'acciones/acciones_avisos.php';
...
case 'avisos_print';
	...
	//Modulo ...AJAX_SEARCH_DOCUMENTOS
case 'searchdocs';
        $incluir = 'ajax-live-search/searchdocs.html';
        $acciones = 'acciones/acciones_documentos.php';
        $seccionweb = 'Buscar documentos';
    break;


	//Modulo ...AJAX_SEARCH_NCS
case 'searchncs';
        $incluir = 'ajax-live-search/searchncs.html';
        $acciones = 'acciones/acciones_ncs.php';
        $seccionweb = 'Buscar NCs';
    break;

	//Modulo ...AJAX_SEARCH_AISGC
case 'searchaisgc';
        $incluir = 'ajax-live-search/searchaisgc.html';
        $acciones = 'acciones/acciones_aisgc.php';
        $seccionweb = 'Buscar NCs';
    break;

	//Modulo ...AJAX_SEARCH_OBJETIVOS
case 'searchobjetivos';
        $incluir = 'ajax-live-search/searchobjetivos.html';
        $acciones = 'acciones/acciones_objetivos.php';
        $seccionweb = 'Buscar Objetivos';
    break;
...
case 'tabs2';
	...
	//Modulo ...SELECTFOLDER
case 'selectfolder';
        $incluir = 'mod/ajaximage/index.php';
        $acciones = 'acciones/acciones_empty.php';
        $seccionweb = 'Upload images';
    break;

	//Modulo ...viewimages
case 'viewimages';
        $incluir = 'mod/ajaximage/selectfolder.php';
        $acciones = 'acciones/acciones_empty.php';
        $seccionweb = 'Ver imágenes';
    break;

	//Modulo ...prueba
case 'prueba';
        $incluir = 'UIUDIPHPMySQL/index.php';
        $acciones = 'acciones/acciones_empty.php';
        $seccionweb = 'Ver imágenes';
    break;
...
//Modulo ...pruebaaddnew
case 'addnew';
        $incluir = 'UIUDIPHPMySQL/addnew.php';
        $acciones = 'acciones/acciones_empty.php';
        $seccionweb = 'Ver imágenes';
    break;

//Modulo ...pruebaeditform
case 'editform';
        $incluir = 'UIUDIPHPMySQL/editform.php';
        $acciones = 'acciones/acciones_empty.php';
        $seccionweb = 'Ver imágenes';
    break;
		...
		//Modulo ...prueba
case 'members';
        $incluir = 'UIUDI_members/index.php';
        $acciones = 'acciones/acciones_empty.php';
        $seccionweb = 'Ver imágenes';
    break;
...
//Modulo ...prueba
case 'membersaddnew';
        $incluir = 'UIUDI_members/addnew.php';
        $acciones = 'acciones/acciones_empty.php';
        $seccionweb = 'Ver imágenes';
    break;

//Modulo ...prueba
case 'memberseditform';
        $incluir = 'UIUDI_members/editform.php';
        $acciones = 'acciones/acciones_empty.php';
        $seccionweb = 'Ver imágenes';
    break;
...
case 'checkbox3_inspecciones';
    ...
    //Modulo ...
case 'checkbox2_codigosincidenciasinspecciones';
        $incluir = 'mod/checkbox2_codigosincidenciasinspecciones.php';
        $acciones = 'acciones/acciones_inspecciones.php';
        $seccionweb = 'Inspecci&oacute;n borrada';
    break;

    //Modulo ...
case 'checkbox3_codigosincidenciasinspecciones';
        $incluir = 'mod/checkbox3_codigosincidenciasinspecciones.php';
        $acciones = 'acciones/acciones_inspecciones.php';
        $seccionweb = 'Borrar una inspecci&oacute;n';
    break;
...
case 'lista_objetivos_y_seguimientos';
    ...
    break;
	    ...
	    //Modulo ...
case 'lista_tareas';
        $incluir = 'mod/lista_tareas.php';
        $acciones = 'acciones/acciones_objetivos.php';
        $seccionweb = 'Tareas por objetivo';
    break;

	    //Modulo ...
case 'tareas_print';
        $incluir = 'mod/tareas_print.php';
        $acciones = 'acciones/acciones_objetivos.php';
        $seccionweb = 'Tareas por objetivo';
    break;
...
case 'tabsframesproveedores';
    ...
    break;
	    ...
	    //Modulo TABSFRAMESCALIBRACIONES
case 'tabsframescalibraciones';
        $incluir = 'mod/tabsframescalibraciones.php';
        $acciones = 'acciones/acciones_empty.php';
        $seccionweb = 'Audministrar calibraciones';
    break;
...
case 'carnetsalert';
    ...
    //Modulo ...
case 'formacionalert';
        $incluir = 'mod/formacionalert.php';
...
case 'checkbox3_servicios';
    ...
    //Modulo ...
case 'fixedheadertable_servicios';
        $incluir = 'fixedheadertable_servicios/index.php';
        $acciones = 'acciones/acciones_servicios.php';
        $seccionweb = 'Borrar un servicio';
    break;
...
case 'poner_curso';
    ...
    //Modulo ...
case 'modimplode';
        $incluir = 'mod/modimplode.php';
        $acciones = 'acciones/acciones_indicadores.php';
        $seccionweb = 'Horas de formación por trabajador';
    break;
...
case 'incidenciasporproveedor_select';
    ...
    //Modulo ...mandar carta a los proveedores_admin
case 'proveedoresalert';
        $incluir = 'mod/proveedoresalert.php';
        $acciones = 'acciones/acciones_proveedores.php';
        $seccionweb = 'Carta a proveedores';
    break;
...
case 'paginatormysqliainc';
    ...
    break;
      ...
      //Modulo ...positivos_enviados
case 'positivos_enviados';
$incluir = 'mod/positivos_enviados.php';
$acciones = 'acciones/acciones_indicadores.php';
$seccionweb = 'ai & ncs';
break;

//Modulo ...insertarpositivoslegionella
case 'insertarpositivoslegionella';
$incluir = 'mod/insertarpositivoslegionella.php';
$acciones = 'acciones/acciones_empty.php';
$seccionweb = 'ai & ncs';
break;

//Modulo ...graficacalidadlegionella
case 'graficacalidadlegionella';
$incluir = 'mod/graficacalidadlegionella.php';
$acciones = 'acciones/acciones_empty.php';
$seccionweb = 'ai & ncs';
break;

//Modulo ...ajaxbootpagbasic
case 'ajaxbootpagbasic';
$incluir = 'mod/ajaxbootpagbasic.php';
$acciones = 'acciones/acciones_ncs.php';
$seccionweb = 'No conformidades';
break;
