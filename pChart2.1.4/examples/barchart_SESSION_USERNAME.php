...
include("../../pChart2.4.1/class/pData.class.php"); 
include("../../pChart2.4.1/class/pDraw.class.php"); 
include("../../pChart2.4.1/class/pImage.class.php"); 
...
$Requete = "SELECT * FROM `cursos` WHERE `trabajador`='$_SESSION[username]'"; //table name
