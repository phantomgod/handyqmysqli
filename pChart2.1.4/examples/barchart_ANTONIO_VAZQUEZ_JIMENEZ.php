...
$Requete = "SELECT * FROM `cursos` WHERE `trabajador`='ANTONIO VÁZQUEZ JIMÉNEZ'"; //table name
...
$myData->setSerieWeight("horas",4); //$myData->setSerieWeight("trabajador",0);
...
$Config = array("R"=>0, "G"=>0, "B"=>0, "Alpha"=>100, "Weight"=>2, "AxisID"=>0, "Ticks"=>8, "WriteCaption"=>TRUE, "Caption"=>"L�mite INF", "DrawBox"=>TRUE);
$myPicture->drawThreshold(10,$Config);
$Config2 = array("R"=>220, "G"=>30, "B"=>40, "Alpha"=>100, "Weight"=>2, "AxisID"=>0, "Ticks"=>8, "WriteCaption"=>1, "Caption"=>"L�mite SUP", "DrawBox"=>TRUE);
